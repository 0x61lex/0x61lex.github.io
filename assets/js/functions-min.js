!function (t, e, i, n) {
  ...
  function r(t, e, i) {
    return Array.isArray(t) ? (o(t, i[e], i), true) : false;
  }
  function o(t, e, i) {
    var s;
  ...
  function D(t, e) {
    ...
    i.firstInput || (i.firstInput = b(e)), s > 1 && !i.firstMultiple ? i.firstMultiple = b(e) : 1 === s && (i.firstMultiple = false);
  ...
  function Y() {
    this.evEl = Ut, this.evWin = jt, this.pressed = false, I.apply(this, arguments);
  }
  function k() {
    this.evEl = Zt, this.evWin = Jt, I.apply(this, arguments), this.store = this.manager.session.pointerEvents = [];
  }
  function q() {
    this.evTarget = Qt, this.evWin = te, this.started = false, I.apply(this, arguments);
  }
  function F(t, e) {
    var i = T(t.touches), n = T(t.changedTouches);
    return e & (Rt | Mt) && (i = y(i.concat(n), "identifier", true)), [i, n];
  }
  function W() {
  ...
  function H(t, e) {
    ...
    if (e & (Pt | Ot) && 1 === i.length) return n[i[0].identifier] = true, [i, i];
    var s, r, o = T(t.changedTouches), a = [], l = this.target;
    if (r = i.filter(function (t) {
      return f(t.target, l);
    }), e === Pt) for (s = 0; s < r.length;) n[r[s].identifier] = true, s++;
    for (s = 0; s < o.length;) n[o[s].identifier] && a.push(o[s]), e & (Rt | Mt) && delete n[o[s].identifier], s++;
    return a.length ? [y(r.concat(a), "identifier", true), a] : void 0;
  }
  function L() {
  ...
  function Z() {
    ...
    return ["auto", "manipulation", "pan-y", "pan-x", "pan-x pan-y", "none"].forEach(function (n) {
      e[n] = i ? t.CSS.supports("touch-action", n) : true;
    }), e;
  }
  function J(t) {
    this.options = Tt({}, this.defaults, t || {}), this.id = E(), this.manager = null, this.options.enable = u(this.options.enable, true), this.state = fe, this.simultaneous = {}, this.requireFail = [];
  }
  function K(t) {
  ...
  function ct(t, e) {
    this.options = Tt({}, lt.defaults, e || {}), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.oldCssProps = {}, this.element = t, this.input = w(this), this.touchAction = new G(this, this.options.touchAction), ht(this, true), o(this.options.recognizers, function (t) {
  ...
  function ut(t, i) {
    ...
    n.initEvent(t, true, true), n.gesture = i, i.target.dispatchEvent(n);
  }
  ...
  var yt = a(function we(t, e, i) {
    ...
    return yt(t, e, true);
  }, "merge", "Use `assign`."), Et = 1, xt = /mobile|tablet|ip(ad|hone|od)|android/i, $t = "ontouchstart" in t, It = C(t, "PointerEvent") !== n, wt = $t && xt.test(navigator.userAgent), At = "touch", Dt = "pen", _t = "mouse", St = "kinect", bt = 25, Pt = 1, Ot = 2, Rt = 4, Mt = 8, zt = 1, Nt = 2, Xt = 4, Yt = 8, kt = 16, qt = Nt | Xt, Ft = Yt | kt, Wt = qt | Ft, Ht = ["x", "y"], Lt = ["clientX", "clientY"];
  I.prototype = {handler: function () {}, init: function () {
  ...
  l(Y, I, {handler: function De(t) {
    var e = Vt[t.type];
    e & Pt && 0 === t.button && (this.pressed = true), e & Ot && 1 !== t.which && (e = Rt), this.pressed && (e & Rt && (this.pressed = false), this.callback(this.manager, e, {pointers: [t], changedPointers: [t], pointerType: _t, srcEvent: t}));
  }});
  var Gt = {pointerdown: Pt, pointermove: Ot, pointerup: Rt, pointercancel: Mt, pointerout: Mt}, Bt = {2: At, 3: Dt, 4: _t, 5: St}, Zt = "pointerdown", Jt = "pointermove pointerup pointercancel";
  t.MSPointerEvent && !t.PointerEvent && (Zt = "MSPointerDown", Jt = "MSPointerMove MSPointerUp MSPointerCancel"), l(k, I, {handler: function _e(t) {
    var e = this.store, i = false, n = t.type.toLowerCase().replace("ms", ""), s = Gt[n], r = Bt[t.pointerType] || t.pointerType, o = r == At, a = g(e, t.pointerId, "pointerId");
    s & Pt && (0 === t.button || o) ? 0 > a && (e.push(t), a = e.length - 1) : s & (Rt | Mt) && (i = true), 0 > a || (e[a] = t, this.callback(this.manager, s, {pointers: e, changedPointers: [t], pointerType: r, srcEvent: t}), i && e.splice(a, 1));
  }});
  var Kt = {touchstart: Pt, touchmove: Ot, touchend: Rt, touchcancel: Mt}, Qt = "touchstart", te = "touchstart touchmove touchend touchcancel";
  l(q, I, {handler: function Se(t) {
    var e = Kt[t.type];
    if (e === Pt && (this.started = true), this.started) {
      var i = F.call(this, t, e);
      e & (Rt | Mt) && i[0].length - i[1].length === 0 && (this.started = false), this.callback(this.manager, e, {pointers: i[0], changedPointers: i[1], pointerType: At, srcEvent: t});
    }
  }});
  var ee = {touchstart: Pt, touchmove: Ot, touchend: Rt, touchcancel: Mt}, ie = "touchstart touchmove touchend touchcancel";
  l(W, I, {handler: function be(t) {
  ...
  var ne = 2500, se = 25;
  l(L, I, {handler: function Pe(t, e, i) {
  ...
  J.prototype = {defaults: {}, set: function (t) {
    ...
    for (var t = 0; t < this.requireFail.length;) {
      if (!(this.requireFail[t].state & (Ce | fe))) return false;
      t++;
    }
    return true;
  ...
  }, process: function (t) {}, getTouchAction: function () {}, reset: function () {}}, l(et, J, {defaults: {pointers: 1}, attrTest: function (t) {
    var e = this.options.pointers;
    return 0 === e || t.pointers.length === e;
  }, process: function (t) {
    var e = this.state, i = t.eventType, n = e & (ve | me), s = this.attrTest(t);
    return n && (i & Mt || !s) ? e | ye : n || s ? i & Rt ? e | ge : e & ve ? e | me : ve : Ce;
  }}), l(it, et, {defaults: {event: "pan", threshold: 10, pointers: 1, direction: Wt}, getTouchAction: function () {
    var t = this.options.direction, e = [];
    return t & qt && e.push(de), t & Ft && e.push(ue), e;
  }, directionTest: function (t) {
    var e = this.options, i = true, n = t.distance, s = t.direction, r = t.deltaX, o = t.deltaY;
  ...
  }}), l(nt, et, {defaults: {event: "pinch", threshold: 0, pointers: 2}, getTouchAction: function () {
    return [he];
  }, attrTest: function (t) {
  ...
  }}), l(st, J, {defaults: {event: "press", pointers: 1, time: 251, threshold: 9}, getTouchAction: function () {
    return [le];
  }, process: function (t) {
  ...
  }}), l(rt, et, {defaults: {event: "rotate", threshold: 0, pointers: 2}, getTouchAction: function () {
    return [he];
  }, attrTest: function (t) {
    return this._super.attrTest.call(this, t) && (Math.abs(t.rotation) > this.options.threshold || this.state & ve);
  }}), l(ot, et, {defaults: {event: "swipe", threshold: 10, velocity: .3, direction: qt | Ft, pointers: 1}, getTouchAction: function () {
  ...
  }}), l(at, J, {defaults: {event: "tap", pointers: 1, taps: 1, interval: 300, time: 250, threshold: 9, posThreshold: 10}, getTouchAction: function () {
    return [ce];
  }, process: function (t) {
    var e = this.options, i = t.pointers.length === e.pointers, n = t.distance < e.threshold, r = t.deltaTime < e.time;
    ...
    if (n && r && i) {
      ...
      var o = this.pTime ? t.timeStamp - this.pTime < e.interval : true, a = !this.pCenter || M(this.pCenter, t.center) < e.posThreshold;
  ...
  }}), lt.VERSION = "2.0.8", lt.defaults = {domEvents: false, touchAction: ae, enable: true, inputTarget: null, inputClass: null, preset: [[rt, {enable: false}], [nt, {enable: false}, ["rotate"]], [ot, {direction: qt}], [it, {direction: qt}, ["swipe"]], [at], [at, {event: "doubletap", taps: 2}, ["tap"]], [st]], cssProps: {userSelect: "none", touchSelect: "none", touchCallout: "none", contentZooming: "none", userDrag: "none", tapHighlightColor: "rgba(0,0,0,0)"}};
  var Ee = 1, xe = 2;
  ct.prototype = {set: function (t) {
    ...
    this.element && ht(this, false), this.handlers = {}, this.session = {}, this.input.destroy(), this.element = null;
  ...
  function t(t) {
    var n = $(".side-nav").find(".is-active"), s = $(".side-nav").children().index(n), r = $(".side-nav").children().length - 1, o = 0;
  ...
  function s() {
    $(".slider--prev, .slider--next").click(function () {
      var t = $(this), e = $(".slider").find(".slider--item-left"), i = $(".slider").children().index(e), n = $(".slider").find(".slider--item-center"), s = $(".slider").children().index(n), r = $(".slider").find(".slider--item-right"), o = $(".slider").children().index(r), a = $(".slider").children().length, l = $(".slider--item-left"), c = $(".slider--item-center"), h = $(".slider--item-right"), u = $(".slider--item");
  ...
  $(this).on("mousewheel DOMMouseScroll", function (e) {
    if (!$(".outer-nav").hasClass("is-vis")) {
      ...
      i > 50 && o ? (o = false, clearTimeout(a), a = setTimeout(function () {
        o = true;
      }, 800), t(1)) : -50 > i && o && (o = false, clearTimeout(a), a = setTimeout(function () {
        o = true;
      }, 800), t(-1));
    }
  }), $(".side-nav li, .outer-nav li").click(function () {
    if (!$(this).hasClass("is-active")) {
      var t = $(this), n = t.parent().find(".is-active"), s = t.parent().children().index(n), r = t.parent().children().index(t), o = $(this).parent().children().length - 1;
      e(r), i(s, r, o);
    }
  }), $(".cta").click(function () {
    var t = $(".side-nav").find(".is-active"), n = $(".side-nav").children().index(t), s = $(".side-nav").children().length - 1, r = s;
    e(s), i(n, r, s);
  });
